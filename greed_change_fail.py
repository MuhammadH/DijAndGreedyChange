...
'''
Now, to demonstate a failure, I changed the values of a quarter to 12 cents

If we enter the value 16 (for 16 cents), the answer will be:
quarter(now worth 12 cents), penny, penny, penny, penny
